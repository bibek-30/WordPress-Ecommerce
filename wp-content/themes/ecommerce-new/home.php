...
<main class="main">
   ...
   <section class="services section body-container" id="services">
      <h1 class="title">Our services</h1>

      <div class="services-container body-grid">
         <div class="services-data">
            <svg class="services-img" xmlns="http://www.w3.org/2000/svg">
               <path d="M45.3205 21.5702L44.6357 19.3163C43.7659 16.756 40.9852 15.3857 38.4249 
                            ...
                            22.1952C43.7565 23.7734 43.8571 25.4416 43.5723 27.0656Z"></path>
               <path d="M28.8 16C28.2109 16 27.7333 16.4776 27.7333 17.0667V26.2251L24.8459 
                            ...
                            27.2209 29.8667 26.9497 29.8667 26.6668V17.0668C29.8667 16.4776 29.3891 16 28.8 16Z"></path>
               <path d="M22.4 16C21.8109 16 21.3333 16.4776 21.3333 17.0667V25.6C21.3333 26.1891 
                            ...
                            16.4776 22.9891 16 22.4 16Z"></path>
               <path d="M25.6 16C25.0109 16 24.5333 16.4776 24.5333 17.0667V25.6C24.5333 26.1891 
                            ...
                            16.4776 26.1891 16 25.6 16Z"></path>
               <path d="M32 0C14.3269 0 0 14.3269 0 32C0 49.6731 14.3269 64 32 64C49.6731 64 64 49.6731 
                            ...
                            15.5051 61.8667 32C61.8479 48.4871 48.4871 61.8479 32 61.8667Z"></path>
               <path d="M35.4625 52.0229C35.4053 51.4367 34.8836 51.0077 34.2972 51.0649C34.2835 
                            ...
                            34.5045 53.1881C35.0908 53.1311 35.5197 52.6093 35.4625 52.0229Z"></path>
               <path d="M48.32 18.2549C47.9414 17.8035 47.2686 17.7445 46.8173 18.1231C46.8158 
                            ...
                            39.283 55.4654 26.7387 48.32 18.2549Z"></path>
               <path d="M24.851 14.0992C24.8505 14.0992 24.85 14.0991 24.8495 14.0991C24.8487 
                            14.0991 24.8478 14.0992 24.8469 14.0992H24.851Z"></path>
               <path d="M37.0315 11.263C32.8628 10.2639 28.4908 10.5324 24.4757 12.0342C23.9243 
                            ...
                            11.9778 37.6041 11.4014 37.0315 11.263Z"></path>
            ...
            <svg class="services-img" xmlns="http://www.w3.org/2000/svg">
               <g clip-path="url(#clip0)">
                  <path d="M19.1978 49.6016C17.4308 49.6016 15.9981 51.0342 15.9981 52.8012C15.9981 54.5682 17.4308 
                            ...
                            53.3902 19.7868 53.8677 19.1978 53.8677Z"></path>
                  <path d="M50.1275 49.6016C48.3605 49.6016 46.9279 51.0342 46.9279 52.8012C46.9279 54.5682 48.3605 
                            ...
                            53.3902 50.7165 53.8677 50.1275 53.8677Z"></path>
                  <path d="M3.19962 21.8715H5.3327V24.0045H3.19962V21.8715Z"></path>
                  <path d="M0 26.1377H2.13308V28.2708H0V26.1377Z"></path>
                  <path d="M52.2606 11.2061H58.6598V13.3391H52.2606V11.2061Z"></path>
                  <path d="M47.9944 11.2061H50.1275V13.3391H47.9944V11.2061Z"></path>
                  <path d="M34.1294 4.80676H44.7948V6.93985H34.1294V4.80676Z"></path>
                  <path d="M29.8632 4.80676H31.9963V6.93985H29.8632V4.80676Z"></path>
                  <path d="M63.9925 59.2005V57.0674H54.8842C55.7935 56.0607 56.3575 54.7906 56.495 53.4412L63.4593 
                            ...
                            52.8012C23.4639 55.1572 21.5537 57.0674 19.1978 57.0674C16.8418 57.0674 14.9316 55.1572 14.9316 52.8012Z"></path>
               </g>
               <defs>
                  <clipPath id="clip0">
   ...
   <section class="products">
      ...
      <div class="cards">
         <a href="#" class="card small">
            <article>
               <img src="https://i.ibb.co/8MMkxxb/16.jpg" alt="Food">
               <h2>Lorem ipsum dolor sit amet consectetur.</h2>
            </article>
         </a>
         <a href="#" class="card big">
            <article>
               <img src="https://i.ibb.co/WD2FLdZ/17.jpg" alt="Food">
         ...
         <a href="#" class="card medium">
            <article>
               <img src="https://i.ibb.co/1GJLXJf/18.jpg" alt="Food">
               <h2>Lorem ipsum dolor sit amet consectetur.</h2>
            </article>
         </a>
         <a href="#" class="card medium">
            <article>
               <img src="https://i.ibb.co/zJh3fCx/19.jpg" alt="Food">
               <h2>Lorem ipsum dolor sit amet consectetur.</h2>
            </article>
         </a>
         <a href="#" class="card small">
            <article>
               <img src="https://i.ibb.co/d67p6QJ/20.jpg" alt="Food">
               <h2>Lorem ipsum dolor sit amet consectetur.</h2>
            </article>
         </a>
         <a href="#" class="card small">
            <article>
               <img src="https://i.ibb.co/XCmRkSg/21.jpg" alt="Food">
               <h2>Lorem ipsum dolor sit amet consectetur.</h2>
            </article>
         </a>
      </div>
